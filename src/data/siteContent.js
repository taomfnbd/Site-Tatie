export const initialSiteContent = {
  ...
  footer: {
    brand: {
      ...
      role: "Naturopathe",
      description:
        "Éducatrice de la santé, je vous accompagne pour devenir autonome et acteur de votre bien-être.",
    },
    contact: {
    ...
    services: [
      {
        ...
        content: {
          ...
          title: "prestations",
          subtitle:
            "Des accompagnements personnalisés pour votre bien-être global",
          imageUrl:
            "https://raw.githubusercontent.com/taomfnbd/image2/main/3.svg",
        },
      },
      {
        ...
        content: {
          ...
          description:
            "Un accompagnement complet pour retrouver votre équilibre naturel grâce à un bilan de vitalité personnalisé.",
          benefits: [
      ...
      },
      {
        ...
        content: {
          ...
          description:
            "Un massage relaxant pratiqué habillé, ciblé sur les zones de tensions du dos, nuque et épaules.",
          benefits: [
    ...
    naturopathy: [
      {
        ...
        content: {
          ...
          subtitle:
            "Une approche naturelle et globale pour devenir acteur de votre bien-être, en harmonie avec votre corps et votre environnement.",
          imageUrl:
            "https://raw.githubusercontent.com/taomfnbd/image2/main/4.svg",
        },
      },
      {
        id: "naturo-about",
      ...
      },
      {
        ...
        content: {
          ...
          intro:
            "Des réponses courtes pour savoir si cet accompagnement correspond à votre besoin avant de prendre rendez-vous.",
          items: [
            {
              question: "À quoi sert un bilan de vitalité ?",
              answer:
                "Le bilan de vitalité permet d'identifier vos habitudes, votre rythme de vie, votre alimentation, votre niveau de stress et vos besoins prioritaires afin de proposer des conseils naturels personnalisés.",
            },
            {
              question: "La naturopathie remplace-t-elle un médecin ?",
              answer:
                "Non. La naturopathie est une approche complémentaire de bien-être. Elle ne pose pas de diagnostic, ne prescrit pas de traitement et ne remplace jamais une consultation médicale.",
            },
            {
              question: "Combien de temps dure une première consultation ?",
              answer:
                "La première consultation dure environ 1h30. Elle comprend un échange approfondi et un bilan de vitalité pour construire un accompagnement adapté.",
            },
            {
    ...
    reflexologie: [
      {
        ...
        content: {
          ...
          subtitle:
            "Une technique naturelle par la stimulation des zones réflexes pour retrouver équilibre, détente et vitalité.",
          imageUrl:
            "https://raw.githubusercontent.com/taomfnbd/image2/main/4.svg",
        },
      },
      {
        ...
        content: {
          ...
          paragraphs: [
            "La réflexologie est une technique manuelle douce qui consiste à stimuler des zones réflexes spécifiques, principalement situées sur les pieds, les mains ou le visage. Ces zones correspondent à différents organes et fonctions du corps.",
            "Par des <strong>pressions rythmées et adaptées</strong>, la réflexologie favorise la détente, améliore la circulation et aide le corps à retrouver son équilibre naturel.",
            "Cette pratique s'adresse à toute personne souhaitant prendre soin de son bien-être de manière naturelle : enfants, adolescents, adultes.",
            "Chaque séance est personnalisée selon vos besoins et votre état du moment.",
          ],
        },
      },
      {
          ...
          steps: [
            {
              ...
              description:
                "Un échange préalable permet d'identifier vos besoins. La séance débute par une détente globale puis cible les zones réflexes adaptées à votre situation.",
              price: "60€",
              duration: "1h",
            },
            {
              ...
              description:
                "Les séances de suivi permettent d'approfondir le travail sur les zones identifiées et d'accompagner votre évolution.",
              price: "50€",
              duration: "45 min",
            },
          ],
      ...
      },
      {
        ...
        content: {
          ...
          benefits: [
            ...
            "Troubles hormonaux, cycles irréguliers",
            "Accompagnement de la grossesse (dès le 4e mois)",
          ],
        },
      },
      {
        ...
        type: "faq",
        content: {
          title: "Questions fréquentes sur la réflexologie",
          intro:
            "Des réponses pour savoir si la réflexologie correspond à votre besoin avant de prendre rendez-vous.",
          items: [
            {
            ...
            {
              question:
                "La réflexologie remplace-t-elle un traitement médical ?",
              answer:
      ...
      },
      {
        ...
        type: "service_cta",
        content: {
          title: "Envie de vous offrir un moment de détente ?",
          showPriceBox: true,
          serviceName: "Première séance",
          duration: "1h",
          price: "60€",
        },
      },
    ...
    massage: [
      {
        ...
        content: {
          title: "Massage assis",
          subtitle:
            "Une pause bien-être pratique et efficace pour soulager les tensions, réduire le stress et retrouver de l'énergie, le tout en restant habillé.",
          imageUrl:
            "https://raw.githubusercontent.com/taomfnbd/image2/main/2.svg",
        },
      },
      {
        id: "massage-about",
          ...
          steps: [
            {
              title: "Installation",
              description:
                "Vous êtes installé(e) confortablement sur une chaise de massage spécialement conçue, en position assise.",
            },
            {
              title: "Massage ciblé",
              description:
                "Les zones massées sont le crâne, les épaules, le dos, les bras et les mains avec des techniques précises.",
            },
            {
              title: "Détente immédiate",
              description:
                "Ressentez les bienfaits dès la fin de la séance : détente, soulagement des tensions et regain d'énergie.",
            },
          ],
        },
      },
      ...
      },
      {
        ...
        content: {
          ...
          intro:
            "Les informations essentielles pour préparer votre séance de massage assis à Vacqueyras.",
          items: [
            {
              question: "Faut-il se déshabiller pour un massage assis ?",
              answer:
                "Non. Le massage assis se pratique habillé, sans huile, sur une chaise de massage adaptée.",
            },
            {
              question: "Combien de temps dure la séance ?",
              answer:
                "La séance de massage assis dure environ 30 minutes. Elle cible les zones de tension les plus fréquentes : dos, nuque, épaules, bras et mains.",
            },
            {
              question: "À qui s'adresse le massage assis ?",
              answer:
                "Le massage assis s'adresse aux personnes qui souhaitent une pause détente rapide, notamment en cas de stress, de tensions musculaires ou de besoin de récupération.",
            },
            {
              question: "Quel est le tarif d'un massage assis ?",
              answer:
                "Le tarif d'une séance complète de massage assis est de 30 euros.",
            },
          ],
        },
      },
    ...
    contact: [
      {
        ...
        content: {
          title:
            'Contact & <span class="text-[#6b7563]">Infos pratiques</span>',
          subtitle:
            "Toutes les informations pour me contacter et organiser votre rendez-vous",
        },
      },
      {
        id: "contact-main",
    ...
    "legal-notice": [
      {
        ...
        type: "legal_content",
        content: {
          title: 'Mentions <span class="text-[#6b7563]">Légales</span>',
          content:
    ...
    "terms-of-service": [
      {
        ...
        content: {
          title:
            'Conditions Générales <span class="text-[#6b7563]">d\'Utilisation</span>',
          content:
