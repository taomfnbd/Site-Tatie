...
import { FiFeather, FiHeart, FiClock, FiCreditCard } from "react-icons/fi";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-green-25 to-stone-25 rounded-2xl p-8 lg:p-10 border border-stone-100"
          >
              ...
              <div className="lg:col-span-2 space-y-6">
                <div className="flex items-center space-x-4">
                  <div className="w-14 h-14 flex items-center justify-center bg-white rounded-xl shadow-sm border border-stone-100">
                    <SafeIcon
                      icon={FiFeather}
                      className="text-[#6b7563] text-2xl"
                    />
                  </div>
                  <div>
                    <h2 className="text-2xl font-medium text-stone-800 tracking-wide">
                      <EditableText
                        value={data.naturopathy.title}
                        onChange={(v) => updateField("naturopathy.title", v)}
                      />
                    </h2>
                    <EditableText
                  ...
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="font-medium text-stone-800 text-sm">
                        <EditableText
                          value={data.naturopathy.price1.type}
                          onChange={(v) =>
                            updateField("naturopathy.price1.type", v)
                          }
                        />
                      </p>
                      <p className="text-xs text-stone-500 flex items-center space-x-1 font-light">
                        ...
                        <span>
                          <EditableText
                            value={data.naturopathy.price1.duration}
                            onChange={(v) =>
                              updateField("naturopathy.price1.duration", v)
                            }
                            element="span"
                          />
                        </span>
                    ...
                    <p className="text-lg font-semibold text-[#6b7563]">
                      <EditableText
                        value={data.naturopathy.price1.price}
                        onChange={(v) =>
                          updateField("naturopathy.price1.price", v)
                        }
                      />
                    </p>
                  </div>
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-stone-25 to-green-25 rounded-2xl p-8 lg:p-10 border border-stone-100"
          >
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              <div className="lg:col-span-2 space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h2 className="text-2xl font-medium text-stone-800 tracking-wide">
                      <EditableText
                        value={data.massage.title}
                        onChange={(v) => updateField("massage.title", v)}
                      />
                    </h2>
                    <EditableText
